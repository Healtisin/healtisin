    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg w-[500px]">
        ...
        <div class="flex items-center justify-between p-4 border-b dark:border-gray-700">
            <div class="flex items-center gap-3">
                <button onclick="closeChangeNameModal()" class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full">
                    <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                </button>
                <h3 class="text-xl font-semibold dark:text-gray-100">Ubah Nama</h3>
            </div>
        </div>
        ...
        <div class="p-6">
            <form id="changeNameForm" method="POST" action="{{ route('profile.name.update') }}" onsubmit="handleNameChange(event)">
                ...
                <!-- Nama Saat Ini -->
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nama Saat Ini</label>
                    <input type="text" 
                           class="w-full px-3 py-2 border rounded-md bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" 
                ...
                <!-- Nama Baru -->
                <div class="mb-6">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nama Baru</label>
                    <input type="text" 
                           id="new_name" 
                           name="name" 
                ...
                <div class="flex justify-end gap-2">
                    <button type="button" onclick="closeChangeNameModal()" class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">
                        Kembali
                    </button>
...
<div id="nameConfirmationModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-[60]">
    <div class="bg-white dark:bg-gray-800 rounded-lg w-[400px] p-6">
        <div class="flex items-center justify-between mb-4">
            <h4 class="text-lg font-medium dark:text-gray-100">Konfirmasi Perubahan Nama</h4>
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-6" id="confirmationMessage"></p>
