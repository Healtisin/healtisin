<aside id="sidebar" class="bg-white dark:bg-gray-800 border-r dark:border-gray-700 flex flex-col h-screen fixed md:relative w-80 z-40 transform -translate-x-full md:translate-x-0">
    ...
    <!-- Logo -->
    <div class="flex-shrink-0 p-6 border-b dark:border-gray-700">
    ...
    <div class="flex flex-col flex-1 min-h-0">
        <!-- New Chat Button -->
        <div class="flex-shrink-0 p-4 border-b dark:border-gray-700">
        ...
        <div class="flex-1 overflow-y-auto min-h-0">
            <div class="p-4">
                ...
                <div class="space-y-2 chat-history">
    ...
    <!-- Profile Section -->
    <div class="flex-shrink-0 border-t dark:border-gray-700 p-4 bg-white dark:bg-gray-800 mt-auto">
        <div class="w-full">
            <!-- User Info -->
            <div class="flex items-center gap-3">
            ...
            <!-- Action Buttons -->
            <div class="flex items-center justify-between px-2 pt-2 border-t dark:border-gray-700 mt-2">
