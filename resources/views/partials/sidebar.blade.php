<aside id="sidebar" class="bg-white dark:bg-gray-800 border-r dark:border-gray-700 flex flex-col transition-all duration-300 w-80 relative">
    ...
    <div class="p-4 border-t dark:border-gray-700">
        <div class="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
            ...
            <div class="flex items-center gap-2 sidebar-text">
                <button onclick="openSettingsModal()" class="p-2 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-full">
                ...
                <form action="{{ route('logout') }}" method="POST" class="inline">
                    @csrf
                    <button type="submit" class="p-2 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-full">
                        <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
