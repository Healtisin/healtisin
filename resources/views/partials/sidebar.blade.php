<aside id="sidebar" class="bg-white border-r flex flex-col transition-all duration-300 w-80 relative">
    ...
    <div class="p-4 border-b mt-auto">
        <button onclick="window.location.reload()"
            class="w-full text-left p-3 rounded-lg bg-[#24b0ba] hover:bg-[#1d8f98] transition-colors">
    ...
    <div class="p-4 border-t">
        <div class="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 transition-colors">
            <div
                class="w-10 h-10 bg-[#24b0ba] rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden">
...
<style>
    ...
    .group:hover .sidebar-text+button {
        opacity: 1;
