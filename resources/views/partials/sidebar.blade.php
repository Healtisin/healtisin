            ...
            @foreach(Auth::user()->chatHistories()->latest('last_interaction')->get() as $history)
                <div class="relative group">
                    ...
                    <button onclick="showDeleteChatModal({{ $history->id }})" 
                            class="absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-full hover:bg-red-50 text-red-500 opacity-0 group-hover:opacity-100 transition-opacity sidebar-text">
