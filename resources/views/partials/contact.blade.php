                    ...
                    <div class="reveal-on-scroll">
                        <div class="grid grid-cols-2 gap-4 max-w-2xl mx-auto">
                            <div
                                ...
                                <p class="text-gray-800 font-medium mb-1">Phone</p>
                                <p class="text-gray-600">+62 892-829-891</p>
                            </div>
                            <div
                                class="bg-[#24b0ba]/10 p-4 rounded-lg hover:shadow-lg transition-shadow flex flex-col items-center text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-12 h-12 mb-2"
                                    fill="#24b0ba">
                                ...
                                <p class="text-gray-600">085292811199</p>
                            </div>
                            <div
                                class="bg-[#24b0ba]/10 p-4 rounded-lg hover:shadow-lg transition-shadow flex flex-col items-center text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-12 h-12 mb-2"
                                ...
                                <p class="text-gray-600">healtisin@gmail.com</p>
                            </div>
                            <div
                                class="bg-[#24b0ba]/10 p-4 rounded-lg hover:shadow-lg transition-shadow flex flex-col items-center text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-12 h-12 mb-2"
                                ...
                                <p class="text-gray-800 font-medium mb-1">Address</p>
                    ...
                    <form id="contactForm" action="{{ route('partials.contact.store') }}" method="POST"
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" required
                                class="mt-1 block w-full px-3 py-2 text-base rounded-md border border-gray-300 shadow-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        <div>
                        ...
                        <div>
                            <button type="submit"
                                class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#24b0ba] hover:bg-[#1a8a8f]">
                                Kirim Pesan
                            </button>
                        </div>
                    </form>
