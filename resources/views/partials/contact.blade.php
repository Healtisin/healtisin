        ...
        <div class="pt-8 sm:pt-12 relative h-[250px] sm:h-[300px] md:h-[500px] overflow-hidden">
            ...
            <div class="relative max-w-6xl mx-auto px-4 h-full flex items-center">
                <div class="text-white text-center md:text-left">
                    <h1 class="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 sm:mb-4 md:mb-6 animate-fade-in">Hubungi
                        Kami</h1>
            ...
            <div class="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-16">
                ...
                <div class="space-y-6 sm:space-y-8">
                    <div class="reveal-on-scroll">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                            <!-- Phone -->
                            <div
                                class="bg-[#24b0ba]/10 dark:bg-[#24b0ba]/20 p-3 sm:p-4 rounded-lg flex flex-col items-center text-center hover:shadow-lg transition-shadow">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    class="w-10 h-10 sm:w-12 sm:h-12 mb-2" fill="#24b0ba">
                                    <path
                            ...
                            <!-- WhatsApp -->
                            <div
                                class="bg-[#24b0ba]/10 dark:bg-[#24b0ba]/20 p-3 sm:p-4 rounded-lg hover:shadow-lg transition-shadow flex flex-col items-center text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    class="w-10 h-10 sm:w-12 sm:h-12 mb-2" fill="#24b0ba">
                                    <path
                ...
                <div class="reveal-on-scroll">
                    ...
                    <form id="contactForm" action="{{ route('partials.contact.store') }}" method="POST"
                        ...
                        <div>
                            <label for="name"
                                class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Nama</label>
                        ...
                        <div>
                            <label for="email"
                                class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Email</label>
                            <input type="email" id="email" name="email" required
                                class="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md border border-gray-300 dark:border-gray-600 shadow-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:text-gray-200">
                        </div>
                        <div>
                            <label for="subject"
                                class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Subjek</label>
                            <input type="text" id="subject" name="subject" required
                                class="mt-1 block w-full px-3 py-2 text-sm sm:text-base rounded-md border border-gray-300 dark:border-gray-600 shadow-md focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:text-gray-200">
                        </div>
                        <div>
                            <label for="message"
                                class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Pesan</label>
