            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="md:col-span-2 lg:col-span-2">
                    ...
                    <div class="flex items-center space-x-6 mb-6 pl-2">
                        ...
                        @endphp
                        @if($footer && $footer->github_link)
                        <a href="{{ $footer->github_link }}" target="_blank" class="text-gray-400 hover:text-gray-300">
                        ...
                        @endif
                        @if($footer && $footer->twitter_link)
                        <a href="{{ $footer->twitter_link }}" target="_blank" class="text-gray-400 hover:text-gray-300">
                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                <path
                    ...
                    <div class="space-y-1 pl-2">
                        <p class="text-gray-400 text-sm">© {{ date('Y') }} Healtisin. All rights reserved.</p>
                        @if($footer && $footer->description)
                            ...
                            @endforeach
                        @else
                            <p class="text-gray-400 text-sm">Healtisin, asisten AI kesehatan terdepan siap menjaga kesehatan Anda 24/7.</p>
                            <p class="text-gray-400 text-sm">Dapatkan skrining kesehatan yang cepat dan akurat dengan teknologi AI mutakhir kami.</p>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="sm:col-span-2 lg:col-span-1">
                        ...
                        <ul class="space-y-3">
                            ...
                            <li class="flex items-center space-x-3">
                                ...
                                <span class="text-gray-400 hover:text-white text-sm whitespace-nowrap">{{ $footer->phone }}</span>
                            </li>
                            @endif
                            ...
                            <li class="flex items-center space-x-3">
                                ...
                                <span
                                    class="text-gray-400 hover:text-white text-sm whitespace-nowrap">{{ $footer->email }}</span>
                            </li>
                            @endif

                            @if($footer && $footer->location)
                            <li class="flex items-center space-x-3">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    class="w-5 h-5 flex-shrink-0 text-white" fill="currentColor">
                                    <path
                                ...
                                <span class="text-gray-400 hover:text-white text-sm whitespace-nowrap">{{ $footer->location }}</span>
                            </li>
                            @endif
                        </ul>
                    </div>
