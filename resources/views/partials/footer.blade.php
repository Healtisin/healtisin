<footer class="bg-gray-900 dark:bg-gray-950 text-white py-12">
    @php
    $footer = \App\Helpers\FooterHelper::getFooterData();
    @endphp
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="md:col-span-2 lg:col-span-2">
                    ...
                    <div class="flex items-center space-x-6 mb-6 pl-2">
                        <a href="{{ $footer->github_link }}" class="text-gray-400 hover:text-gray-300">
                        ...
                        <a href="{{ $footer->twitter_link }}" class="text-gray-400 hover:text-gray-300">
                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                <path
                    ...
                    <div class="space-y-1 pl-2">
                        <p class="text-gray-400 text-sm">{{ $footer->copyright }}</p>
                        <div class="text-gray-400 text-sm">{!! nl2br(e($footer->description)) !!}</div>
                    </div>
                </div>
