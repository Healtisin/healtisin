    ...
    <main class="pt-24 pb-16">
        ...
        <div class="max-w-6xl mx-auto px-4 -mt-20 relative z-10">
            <div class="grid md:grid-cols-3 gap-8">
                <div
                    class="bg-white p-8 rounded-xl shadow-lg transform hover:-translate-y-2 transition-all duration-300 hover:shadow-2xl">
                    <div
                        class="w-16 h-16 bg-[#24b0ba] rounded-lg -mt-12 mb-6 flex items-center justify-center transform rotate-45">
                        <svg class="w-8 h-8 text-white -rotate-45" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
        ...
        <div class="max-w-6xl mx-auto px-4 py-24">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative">
                    ...
                    <img src="{{ asset('images/innovation2.png') }}" alt="Innovation"
