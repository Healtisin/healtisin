...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <div class="flex justify-between items-center">
            <h2 class="text-2xl font-semibold leading-tight text-gray-900 dark:text-gray-100">Users</h2>
            <div class="flex flex-col">
                <span class="mb-2 text-gray-600 dark:text-gray-400">Total Users: {{ $users->count() }}</span>
                <span class="text-gray-600 dark:text-gray-400">Current used: {{ $users->where('is_active', true)->count() }}</span>
            </div>
        </div>
            ...
            <div class="flex space-x-4">
                ...
                <div class="relative">
                    <select id="role-select" onchange="window.location.href = this.value"
                        class="bg-[#24b0ba] dark:bg-[#24b0ba]/80 text-white px-4 py-2 rounded-lg hover:bg-[#73c7e3] dark:hover:bg-[#73c7e3]/80 transition duration-300 appearance-none focus:outline-none">
                ...
                <table class="min-w-full leading-normal">
                    <thead>
                        <tr>
                            ...
                            <th class="px-5 py-3 border-b-2 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Photo</th>
                            <th class="px-5 py-3 border-b-2 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Name</th>
                            <th class="px-5 py-3 border-b-2 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Username</th>
                            <th class="px-5 py-3 border-b-2 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Mobile</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-100">{{ $user->mobile ?? 'N/A' }}</td>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm">
                                @if($user->is_active)
                                <span class="px-2 py-1 text-sm font-semibold text-green-800 dark:text-green-200 bg-green-200 dark:bg-green-800/30 rounded-full">Active</span>
                                @else
                                <span class="px-2 py-1 text-sm font-semibold text-red-800 dark:text-red-200 bg-red-200 dark:bg-red-800/30 rounded-full">Inactive</span>
                                @endif
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm flex items-center space-x-2">
                                <!-- Tombol Edit -->
