    ...
    <div class="py-8">
        ...
        <div class="my-2 flex sm:flex-row flex-col">
            ...
            <div class="flex flex-grow justify-end ml-4">
                <form id="search-form" action="{{ route('admin.users') }}" method="GET" class="flex flex-col md:flex-row items-center gap-4 w-full">
                ...
                <table class="min-w-full leading-normal">
                    <thead>
                        <tr>
                            ...
                            <th class="px-5 py-3 border-b-2 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                                <a href="{{ route('admin.users', ['sort' => 'subscription_status', 'direction' => request('sort') === 'subscription_status' && request('direction') === 'asc' ? 'desc' : 'asc', 'search' => request('search')]) }}" class="flex items-center">
                                    Status Langganan
