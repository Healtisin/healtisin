    ...
    <div class="py-8">
        ...
        <div class="my-2 flex sm:flex-row flex-col">
            <div class="flex space-x-4">
                ...
                <div class="relative">
                    <select id="role-select" onchange="window.location.href = this.value"
                        ...
                        <option value="{{ route('admin.users', ['role' => 'user']) }}" {{ $role === 'user' ? 'selected' : '' }}>Pengguna</option>
            ...
            <div class="flex flex-grow justify-end ml-4">
                <form id="search-form" action="{{ route('admin.users', ['role' => $role]) }}" method="GET" class="flex w-full md:w-auto">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="px-5 py-3 border-b-2 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                                <a href="{{ route('admin.users', ['role' => $role, 'sort' => 'name', 'direction' => request('sort') === 'name' && request('direction') === 'asc' ? 'desc' : 'asc', 'search' => request('search')]) }}" class="flex items-center">
                                    Nama
                            ...
                            <th class="px-5 py-3 border-b-2 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                                <a href="{{ route('admin.users', ['role' => $role, 'sort' => 'username', 'direction' => request('sort') === 'username' && request('direction') === 'asc' ? 'desc' : 'asc', 'search' => request('search')]) }}" class="flex items-center">
                                    Nama Pengguna
                            ...
                            <th class="px-5 py-3 border-b-2 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                                <a href="{{ route('admin.users', ['role' => $role, 'sort' => 'email', 'direction' => request('sort') === 'email' && request('direction') === 'asc' ? 'desc' : 'asc', 'search' => request('search')]) }}" class="flex items-center">
                                    Email
                            ...
                            <th class="px-5 py-3 border-b-2 border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                                <a href="{{ route('admin.users', ['role' => $role, 'sort' => 'is_active', 'direction' => request('sort') === 'is_active' && request('direction') === 'asc' ? 'desc' : 'asc', 'search' => request('search')]) }}" class="flex items-center">
                                    Status
