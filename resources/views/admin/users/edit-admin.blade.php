...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        ...
        @if(session('error'))
            <div class="mb-8 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative dark:bg-red-800/20 dark:border-red-700 dark:text-red-400" role="alert">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8">
            <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST" enctype="multipart/form-data" id="edit-form">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        <label for="password" class="block text-base font-medium text-gray-700 dark:text-gray-300">Kata Sandi (Kosongkan jika tidak diubah)</label>
                    ...
                    <div class="space-y-4">
                        ...
                        <select name="subscription_status" id="subscription_status"
                            ...
                            <option value="PRO" {{ $admin->subscription_status == 'PRO' ? 'selected' : '' }}>PRO</option>
                        </select>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let originalPhotoSrc = currentPhoto ? currentPhoto.src : null;
        let hasPhoto = currentPhoto !== null && currentPhoto !== undefined;
        ...
        photoInput.addEventListener('change', function() {
            if (this.files && this.files[0]) {
                ...
                reader.onload = function(e) {
                    // Simpan foto asli jika ada
                    if (hasPhoto && !originalPhotoSrc) {
                        originalPhotoSrc = currentPhoto.src;
                    }
