...
<div class="p-8" id="scrollDashboard">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <a href="{{ route('admin.users') }}">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer">
        ...
        <a href="#">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer">
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">${{ number_format($todaySales) }} <span
                        class="text-green-500 dark:text-green-400 text-sm">+{{ $salesIncreasePercentage }}%</span></p>
            </div>
        </a>

        <a href="#">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer">
                <p class="text-gray-500 dark:text-gray-400">Avg. Order Amount</p>
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">15,235 <span class="text-red-500 dark:text-red-400 text-sm">-2.8%</span></p>
            </div>
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            <h2 class="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100">Expense & Income</h2>
            <div class="flex justify-between items-center mb-4">
                <p class="text-gray-500 dark:text-gray-400">Expense</p>
                <p class="text-gray-500 dark:text-gray-400">Income</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">$4,235</p>
                    <p class="text-gray-500 dark:text-gray-400">BBO Park</p>
                    <p class="text-gray-500 dark:text-gray-400">3251 Orders + $2,154 earned</p>
                </div>
                <div>
                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">$52,319</p>
                    <p class="text-gray-500 dark:text-gray-400">Masala Pasta</p>
                    <p class="text-gray-500 dark:text-gray-400">3251 Orders + $1,233 earned</p>
                </div>
            </div>
        </div>
    </div>
