...
<head>
    ...
    <title>Kesalahan Server - Healtisin AI</title>
...
<body class="bg-gray-50">
    <div class="min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div class="text-center max-w-lg">
            <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">
                Oops! Terjadi Kesalahan Server
            </h1>
            <p class="text-sm sm:text-base md:text-lg text-gray-600 mb-6 sm:mb-8">
                Mohon maaf, server kami sedang mengalami gangguan. Tim teknis kami sedang bekerja untuk memperbaikinya.
            </p>
        ...
        <div class="text-center">
            <div class="flex items-center justify-center gap-2 text-gray-400 mb-2">
                ...
                <span class="text-xs sm:text-sm">&copy; {{ date('Y') }} Healtisin AI</span>
            </div>
